...
# from onmt.encoders.new_mtransformer import TransformerEncoder
# from onmt.decoders.new_mtransformer  import TransformerDecoder
# from onmt.models.new_model import KTransformerModel

# from onmt.encoders.mtransformer import TransformerEncoder
# from onmt.decoders.mtransformer  import TransformerDecoder
# from onmt.models.model import KTransformerModel

from onmt.encoders.final_mtransformer import TransformerEncoder
from onmt.decoders.final_mtransformer  import TransformerDecoder
from onmt.models.final_model import KTransformerModel
...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    #model = KTransformerModel(encoder, decoder, decoder2)
    model = KTransformerModel(encoder, decoder)
